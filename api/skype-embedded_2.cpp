...
Skype::Skype(int num_threads) : SERootObject(num_threads) {}
Skype::~Skype() {}
...
const unsigned int ContactGroup::moduleID() const 
{
        return MODULE_ID;
}
...
const unsigned int Contact::moduleID() const 
{
        return MODULE_ID;
}
...
const unsigned int ContactSearch::moduleID() const 
{
        return MODULE_ID;
}
...
const unsigned int Participant::moduleID() const 
{
        return MODULE_ID;
}
...
const unsigned int Conversation::moduleID() const 
{
        return MODULE_ID;
}
...
const unsigned int Message::moduleID() const 
{
        return MODULE_ID;
}
...
extern const EMAP MESSAGE_EMAP[] = {
        ...
        {Message::P_LEAVEREASON, MESSAGE_LEAVEREASON_MAP},
        {0, 0}
};
...
const unsigned int Video::moduleID() const 
{
        return MODULE_ID;
}
...
void Video::OnLastFrameCapture(
        __se_unused const Sid::Binary& /*image*/,
        __se_unused const uint& /*width*/,
        __se_unused const uint& /*height*/
) {}
...
const unsigned int Voicemail::moduleID() const 
{
        return MODULE_ID;
}
...
const unsigned int Sms::moduleID() const 
{
        return MODULE_ID;
}
...
const unsigned int Transfer::moduleID() const 
{
        return MODULE_ID;
}
...
const unsigned int Account::moduleID() const 
{
        return MODULE_ID;
}
